...
func (ec *executionContext) _HelloResponse_message(ctx context.Context, field graphql.CollectedField, obj *model.HelloResponse) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_HelloResponse_message,
...
func (ec *executionContext) fieldContext_HelloResponse_message(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) fieldContext_Query_hello(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "message":
				return ec.fieldContext_HelloResponse_message(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type HelloResponse", field.Name)
		},
	}
	return fc, nil
}
...
func (ec *executionContext) _HelloResponse(ctx context.Context, sel ast.SelectionSet, obj *model.HelloResponse) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, helloResponseImplementors)
